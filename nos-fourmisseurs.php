...
<>
    ...
    <nav>
      <div class="nav-bar">
        ...
        <div class="menu">
          ...
          <ul class="nav-links">
            <li><a href="index.php" id="">Acceuil</a></li>
            <li><a href="nos-ordinatour.php">Produits</a></li>
            <li><a href="nos-coffrets.php">Offres</a></li>
            <li class="this"><a href="nos-fourmisseurs.php">Fornisseur</a></li>
            <li><a href="qui-sommes.php">About us</a></li>
  ...
  <main class="main">
    <div class="container-m">
      <div class="blog">
        <h2 class="h2" style="color:#9e121b">Fornisseur</h2>
