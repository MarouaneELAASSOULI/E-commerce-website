...
<div class="adminbody">
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div>
            <label for="">Quantite d'ordinateur :</label>
