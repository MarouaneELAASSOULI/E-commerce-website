    ...
    <table class='table table-striped mt-2'>
        ...
        <?php foreach ($tab as $val) { ?>
            ...
            <tr>
                ...
                <td>
                    <a href="?sepp=<?= $val['id_fornisseur'] ?>" onclick="return confirm('Voulez-vous supprimer Offre') "><i class="fa-solid fa-xmark"></i></a>
...
?>
    ...
    <div class="adminbody">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div>
                <a href="Gestion_des_fornisseur.php" class="btn btn-outline-danger">Gestion Des Offre</a>
            </div>
        </form>
    </div>
