...
?>
<h1 align="center" class="text-danger">Gestion des Offres</h1>
<?php
include "../inc/db.php";
...
?>
    ...
    <div class="adminbody">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div>
                <a href="Gestion_des_couffre.php" class="btn btn-outline-danger">Gestion Des Offres</a>
            </div>
        </form>
    </div>
